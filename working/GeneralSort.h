...
//   Int_t           RunNum;
   Int_t           NumHits;
   Short_t         id[40];   //[NumHits]
//   UShort_t        tpe[40];   //[NumHits]
//   UShort_t        tid[40];   //[NumHits]
   UShort_t        chan_id[40];   //[NumHits]
   UShort_t        board_id[40];   //[NumHits]
   UShort_t        geo_addr[40];   //[NumHits]
   UShort_t        packet_length[40];   //[NumHits]
   UShort_t        header_type[40];   //[NumHits]
   UShort_t        event_type[40];   //[NumHits]
   UShort_t        header_length[40];   //[NumHits]
   ULong64_t       event_timestamp[40];   //[NumHits]
   ULong64_t       last_disc_timestamp[40];   //[NumHits]
   ULong64_t       peak_timestamp[40];   //[NumHits]
   UShort_t        timestamp_match_flag[40];   //[NumHits]
   UShort_t        external_disc_flag[40];   //[NumHits]
   UShort_t        cfd_valid_flag[40];   //[NumHits]
   UShort_t        pileup_only_flag[40];   //[NumHits]
   UShort_t        offset_flag[40];   //[NumHits]
   UShort_t        sync_error_flag[40];   //[NumHits]
   UShort_t        general_error_flag[40];   //[NumHits]
   UShort_t        peak_valid_flag[40];   //[NumHits]
   UShort_t        pileup_flag[40];   //[NumHits]
   Int_t           sampled_baseline[40];   //[NumHits]
   Int_t           cfd_sample_0[40];   //[NumHits]
   Int_t           cfd_sample_1[40];   //[NumHits]
   Int_t           cfd_sample_2[40];   //[NumHits]
   Int_t           pre_rise_energy[40];   //[NumHits]
   Int_t           post_rise_energy[40];   //[NumHits]
//   UShort_t        m1_begin_sample[40];   //[NumHits]
//   UShort_t        m1_end_sample[40];   //[NumHits]
//   UShort_t        m2_begin_sample[40];   //[NumHits]
//   UShort_t        m2_end_sample[40];   //[NumHits]
   UShort_t        peak_sample[40];   //[NumHits]
   UShort_t        base_sample[40];   //[NumHits]
   Int_t           baseline[40];   //[NumHits]
   UShort_t        trace_length[40];   //[NumHits]
